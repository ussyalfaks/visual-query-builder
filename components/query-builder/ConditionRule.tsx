...
export const ConditionRule = memo(function ConditionRule({ rule, groupId }: Props) {
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        'flex items-center gap-2 rounded-md border bg-background p-2 group transition-all',
    ...
    >
      ...
      {/* Field selector */}
      <select
        className="h-8 rounded-md border border-input bg-background px-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring w-32 shrink-0"
        value={rule.field}
